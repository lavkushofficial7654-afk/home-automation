/*
 * ESP8266 Guest Network LED Control
 * 
 * This connects to your router's guest network
 * so ESP8266 and your devices can communicate
 */

#include <ESP8266WiFi.h>
#include <ESP8266WebServer.h>

// Guest Network credentials (update these with your actual guest network details)
...
void setup() {
  ...
  Serial.println("=====================================");
  Serial.println("ESP8266 Guest Network LED Control");
  Serial.println("=====================================");
...
void handleRoot() {
  ...
  html += ".guest { background: linear-gradient(45deg, #d4edda, #c3e6cb); color: #155724; padding: 15px; border-radius: 10px; margin: 15px 0; }";
  ...
  html += "✅ Connected to Guest Network<br>";
  html += "Network: " + String(ssid) + "<br>";
