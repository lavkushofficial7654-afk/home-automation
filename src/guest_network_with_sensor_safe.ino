/*
 * ESP8266 Guest Network + Ultrasonic Sensor (Safe Version)
 * 
 * Based on the working guest_network_esp8266.ino
 * Adds ultrasonic sensor with safe pin management
 */
...
void setup() {
  ...
  Serial.println("=====================================");
  Serial.println("ESP8266 Guest Network + Sensor");
  Serial.println("=====================================");
